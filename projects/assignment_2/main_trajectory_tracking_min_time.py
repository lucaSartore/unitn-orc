...
def define_running_cost_and_dynamics(opti: cs.Opti, X, U, S, W, N, dt, x_init,
    ...
    for k in range(N):
        ...
        # note: this "running cost" could be optimized by bringing it out of the
        # loop and multiply it by N. I decided to leave it like this, so it is more
        # clear that is a running cost, and the performance impact seem to be minimal
        cost += w_dt * (dt ** 2)
